 ...
 * @author User
 */
public class registerAbsensi extends javax.swing.JFrame {

    /**
     * Creates new form registerAbsensi
     */
    public registerAbsensi() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registerAbsensi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registerAbsensi().setVisible(true);
            }
        });
    }
