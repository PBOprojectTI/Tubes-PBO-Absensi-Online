 ...
 * @author user
 */
public class listAbsenadmin extends javax.swing.JFrame {
private DefaultTableModel model;
    /**
     * Creates new form listAbsenadmin
     */
    public listAbsenadmin() {
        initComponents();
...
// "table_buku sesuaikan dengan variabel name"
        ...
        model.addColumn("Jenis_Perkuliahan");
...
//pengecekan terhadap data tabel_buku
           while(res.next ()){
                ...
                obj[4] = res.getString("jenis_perkuliahan");
                model.addRow(obj);
            }
    ...
    private void initComponents() {
        ...
        tabelHasil.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nomor", "Tanggal Absen", "Nama", "Mata kuliah", "Jenis Perkuliahan"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listAbsenadmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new listAbsenadmin().setVisible(true);
            }
        });
    }
